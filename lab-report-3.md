...
```
[cs15lwi23aar@ieng6-203]:written_2:263$ find . -type d
.
./non-fiction
./non-fiction/OUP
...
./travel_guides/berlitz2/Portugal-WhereToGo.txt
```
Searches for files less than 100 kilobytes.
```
[cs15lwi23aar@ieng6-203]:written_2:283$ find . -size -100k
.
./non-fiction
./non-fiction/OUP
./non-fiction/OUP/Abernathy
...
./travel_guides/berlitz2/Vallarta-WhereToGo.txt
```
The -size command-line option searches for files that are within the directory and satisfy a certain size command. This is useful because it tells you which files you might be able to upload based off of size requirements.

## find -print directory
Searches through the travel_guides directory.
```
[cs15lwi23aar@ieng6-203]:written_2:243$ find -P travel_guides/
travel_guides/
travel_guides/berlitz1
travel_guides/berlitz1/HandRHawaii.txt
travel_guides/berlitz1/HandRHongKong.txt
...
Search through the non-fiction directory.
```
[cs15lwi23aar@ieng6-203]:written_2:244$ find -P non-fiction/  
non-fiction/
non-fiction/OUP
non-fiction/OUP/Abernathy
non-fiction/OUP/Abernathy/ch1.txt
